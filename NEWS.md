# NEWS for rsync 3.4.1-sec-patches4 (UNRELEASED)

This update corrects regressions and edge cases in the path-confinement
hardening published in `3.4.1-sec-patches3`. It contains no new features or
...
------------------------------------------------------------------------------
# NEWS for rsync 3.4.1-sec-patches3

This is a security-only update to the 3.4.1 maintenance release.  It backports
the path-handling and daemon-protocol security fixes from the 3.5.0 audit onto
the 3.4.1 base, with no feature changes.  The fixes are validated against the
3.5.0 security regression test suite.
